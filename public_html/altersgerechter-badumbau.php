            ...
            <div class="contact-grid">
                <div class="contact-sidebar">
                    ...
                    <div class="contact-process-steps">
                        ...
                        <div class="contact-process-step"><strong>4</strong> Fördercheck &amp; detailliertes Festpreis-Angebot</div>
                    </div>
                </div>
                <div class="contact-form-wrap">
                    <form class="contact-form" action="/includes/form-handler.php" method="POST" novalidate>
                        ...
                        <div class="form-field-hp" aria-hidden="true" tabindex="-1">
                            <label for="website_url_ab">Website</label>
                            <input type="text" name="website_url" id="website_url_ab" autocomplete="off" tabindex="-1">
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label for="ab_name" class="form-label">Name <span class="required" aria-label="Pflichtfeld">*</span></label>
                                <input type="text" id="ab_name" name="name" class="form-input" required minlength="2" maxlength="100" placeholder="Ihr vollständiger Name" autocomplete="name">
                            </div>
                            <div class="form-group">
                                <label for="ab_phone" class="form-label">Telefon <span class="required" aria-label="Pflichtfeld">*</span></label>
                                <input type="tel" id="ab_phone" name="phone" class="form-input" required placeholder="+49 123 456 789" autocomplete="tel">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="ab_email" class="form-label">E-Mail <span class="required" aria-label="Pflichtfeld">*</span></label>
                            <input type="email" id="ab_email" name="email" class="form-input" required placeholder="ihre@email.de" autocomplete="email">
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label for="ab_plz" class="form-label">Postleitzahl <span class="required" aria-label="Pflichtfeld">*</span></label>
                                <input type="text" id="ab_plz" name="plz" class="form-input" maxlength="5" pattern="[0-9]{5}" placeholder="72805" autocomplete="postal-code" inputmode="numeric" required>
                            </div>
                            <div class="form-group">
                                <label for="ab_stadt" class="form-label">Ort</label>
                                <input type="text" id="ab_stadt" name="stadt" class="form-input" placeholder="wird automatisch erkannt" autocomplete="address-level2">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="ab_message" class="form-label">Ihr Projekt <span class="required" aria-label="Pflichtfeld">*</span></label>
                            <textarea id="ab_message" name="message" class="form-input form-textarea" required minlength="10" maxlength="5000" rows="4" placeholder="Kurze Beschreibung: Was soll umgebaut werden? Für wen? Ungefähre Vorstellung?"></textarea>
                        </div>
                        <div class="form-group">
