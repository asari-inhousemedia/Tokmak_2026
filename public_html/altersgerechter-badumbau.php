            ...
            <div class="contact-grid">
                ...
                <div class="contact-form-wrap">
                    <form class="contact-form" action="/includes/form-handler.php" method="POST" novalidate>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="ab_plz" class="form-label">Postleitzahl <span class="optional">(optional)</span></label>
                                <input type="text" id="ab_plz" name="plz" class="form-input" maxlength="5" pattern="[0-9]{5}" placeholder="72805" autocomplete="postal-code" inputmode="numeric">
                            </div>
                            <div class="form-group">
