...
$pageTitle       = 'Impressum';
$pageDescription = 'Impressum und Angaben gemäß § 5 TMG von ' . SITE_NAME;
$pageSlug        = 'impressum';
?>
<!DOCTYPE html>
<html lang="de">
    ...
    <section class="section">
        <div class="container content-narrow">
            ...
            <p>
                ...
                <?php echo CONTACT_ADDRESS_COUNTRY; ?>
            </p>

            <h2>Vertreten durch</h2>
            <p><?php echo LEGAL_OWNER; ?></p>

            <h2>Kontakt</h2>
            <p>
                Telefon: <a href="tel:<?php echo CONTACT_PHONE; ?>"><?php echo CONTACT_PHONE; ?></a><br>
                E-Mail: <a href="mailto:<?php echo CONTACT_EMAIL; ?>"><?php echo CONTACT_EMAIL; ?></a>
            </p>

            <h2>Registereintrag</h2>
            <p><?php echo LEGAL_REGISTER; ?></p>

            <h2>Umsatzsteuer-ID</h2>
            <p>Umsatzsteuer-Identifikationsnummer gemäß § 27a Umsatzsteuergesetz:<br>
            <?php echo LEGAL_TAX_ID; ?></p>

            <h2>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h2>
            <p>
                <?php echo LEGAL_OWNER; ?><br>
                <?php echo CONTACT_ADDRESS_STREET; ?><br>
                <?php echo CONTACT_ADDRESS_ZIP . ' ' . CONTACT_ADDRESS_CITY; ?>
            </p>
